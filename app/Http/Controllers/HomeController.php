...
// ---------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public function showeditprofile($id)
    {
        ...
        $editprofile = Student_information::where('id', $id)->firstOrFail();
        $user = Student_information::all()->find($id);
        return view('edit_form', compact('user','editprofile'));
    }

    public function updatenewprofile(Request $request, $id)
    {
...
// ---------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        Student_information::where('id', $id)->update($input_profile);
        // dd($input_profile);
